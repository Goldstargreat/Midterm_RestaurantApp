# 🍴 Restaurant List Manager (맛집 리스트 매니저)
> **2026학년도 1학기 안드로이드 프로그래밍 중간고사 대체 과제**

사용자가 가고 싶은 식당이나 단골집 목록을 동적으로 관리할 수 있는 안드로이드 애플리케이션입니다. `ListView`와 `ArrayAdapter`를 활용하여 맛집의 추가, 삭제 및 상태 표시 기능을 구현함으로써 안드로이드의 핵심 데이터 바인딩 원리를 적용했습니다.
