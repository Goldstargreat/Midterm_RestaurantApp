...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        int[] catIds =
                {
                R.id.btn_cat_all, R.id.btn_cat_korean, R.id.btn_cat_western,
                R.id.btn_cat_japanese, R.id.btn_cat_china, R.id.btn_cat_etcetra
        };
        for (int id : catIds)
        {
            findViewById(id).setOnClickListener(catListener);
        }
        ...
        findViewById(R.id.btn_add).setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                listAll.add(name);
                numsAll.add(num.isEmpty() ? "번호 없음" : num);

                int checkedId = rgCategory.getCheckedRadioButtonId();
                if (checkedId == R.id.rb_korean)
                {
                    listKorean.add(name); numsKorean.add(num);
                }
                else if (checkedId == R.id.rb_western)
                {
                    listWestern.add(name); numsWestern.add(num);
                }
                else if (checkedId == R.id.rb_japanese)
                {
                    listJapanese.add(name); numsJapanese.add(num);
                }
                else if (checkedId == R.id.rb_china)
                {
                    listChina.add(name); numsChina.add(num);
                }
                else if (checkedId == R.id.rb_etcetra)
                {
                    listEtc.add(name); numsEtc.add(num);
                }
